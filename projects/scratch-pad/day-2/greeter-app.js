...
function greeter(hour) {
    ...
    // hour needs to be either equal to or greater than hour or equal to or less than 11 for it to read Good Morning!
    if (hour <= 11){
        console.log("Good Morning!");
        // if hour is equal to or less than 16, console.log "Good Afternoon."
    } else if (hour <= 16){
        console.log("Good Afternoon!");
        // If hour is less than or equal to 21, log "Good Evening."
    } else if (hour <= 21){
        console.log("Good Evening!");
        // In care none of this is true, print "Good Night."
    } else {
 ...
 * the hour, so just change the inp(ut value to check your work.
 * 
